...
namespace TenmoServer.DAO
{
    public class UserSqlDAO : IUserDAO
    {
        ...
        public List<User> GetOtherUsers(int self_user_id)
        {
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(connectionString))
                {
                    ...
                    SqlCommand cmd = new SqlCommand("SELECT user_id, username, password_hash, salt FROM users WHERE user_id <> @self_user_id", conn);
                    cmd.Parameters.AddWithValue("@self_user_id", self_user_id);
                    SqlDataReader reader = cmd.ExecuteReader();
